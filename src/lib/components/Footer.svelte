  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-8">
    ...
    <div class="text-center md:text-left">
      ...
      <div class="flex justify-center md:justify-start gap-4 mt-4">
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="flex items-center justify-center w-10 h-10 bg-gray-800 hover:bg-primary rounded-full text-white hover:transform hover:-translate-y-1 transition-all">
    ...
    <div class="text-center md:text-left">
      ...
      <p class="text-gray-400 leading-relaxed mb-2">Email: contact@capturemoments.com</p>
      <p class="text-gray-400 leading-relaxed mb-2">Phone: +233 123 456 7890</p>
    </div>
  </div>
